...
{ 
    ...
    String operacion="";
    int escribirR=0;
    public  void LeerOperaciones(String archivoL,String archivoR)
    {   //Lee el archivo txt y los envia a la funcion separarPolinomio   
        FileReader archivo;
        BufferedReader lector;
        try
        {
            archivo = new FileReader(archivoL+".txt");
            if (archivo.ready())
            {
    ...
    public Lista obtenerDatosLista1(int base, String variable, int exponente){
        lista1.insertar(new Monomio(base, variable, exponente)); 
        return lista1;
    }

    public Lista obtenerDatosLista2(int base, String variable, int exponente){
        lista2.insertar(new Monomio(base, variable, exponente)); 
        return lista2;
    }
    ...
    //********************************************************************************
    public void operarPolinomios(String archivoR)
    {  Monomio[] vectorLista1=lista1.getData();
        ...
        if(escribirR==0){
        Monomio[] vectorLista3=lista3.getData();
        escribir(vectorLista3,vectorLista2,vectorLista1,archivoR);
        escribirR++;
        }
    }
    ...
    public void escribir(Monomio[] resultado,Monomio[] polinomio2,Monomio[] polinomio1, String archivoR)
    {
        ...
        try
        {
            archivo = new FileWriter(archivoR+".txt",true);
